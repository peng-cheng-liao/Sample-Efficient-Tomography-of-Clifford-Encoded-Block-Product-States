...
def collect_error_data_for_n(n):
    """
    For a fixed n, load all available files over M_list.
    ...
    for M in M_list:
        ...
        total_samples = total_measurements(n, M)
...
for row, n in enumerate(n_list):
    ...
    ax.set_xlabel(r"Total samples $3^n M$")
...
plt.tight_layout()
plt.savefig("Figs/05_v2.jpg", dpi=500)
plt.show()
